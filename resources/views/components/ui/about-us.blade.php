<div class="isolate overflow-hidden relative py-24 bg-gray-900 sm:py-32">
  ...
  <div class="px-6 mx-auto max-w-7xl lg:px-8">
    ...
    <div class="grid grid-cols-1 gap-6 items-center mx-auto mt-16 max-w-2xl h-full sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-8">
      <div class="flex gap-x-4 p-6 rounded-xl ring-1 ring-inset bg-white/5 ring-white/10">
        <svg class="flex-none w-5 h-7 text-indigo-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
