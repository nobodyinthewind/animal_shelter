  ...
  <div class="px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-24 lg:px-8 lg:pt-32">
    ...
    <div class="pt-8 mt-16 border-t border-gray-900/10 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
      ...
      <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
        ...
        <input type="email" name="email-address" id="email-address" autocomplete="email" required class="px-3 py-1.5 w-full min-w-0 text-base text-gray-900 bg-white rounded-md border-0 ring-1 ring-inset ring-gray-300 shadow-sm appearance-none placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:w-56 sm:text-sm sm:leading-6" placeholder="Enter your email">
        <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
          <button type="submit" class="flex justify-center items-center px-3 py-2 w-full text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Subscribe</button>
        </div>
      </form>
    </div>
    <div class="pt-8 mt-8 border-t border-gray-900/10 md:flex md:items-center md:justify-between">
      ...
      <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy; 2024 Animal Shelter. All rights reserved.</p>
    </div>
  </div>
</footer>